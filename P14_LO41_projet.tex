...
%%%%%%%%%%%% conclusion %%%%%%%%%%%%%%%
\section{Conclusion}
Ce projet a été fortement intéressant cela a été l'occasion de pouvoir mettre en pratique sur un cas concret les concepts vu tout au long du semestre.
\paragraph{Avis sur ce qui serait bien de faire}


\paragraph{}Si nous avions eu plus de temps, il aurait fallu ...\\
Nous aurions pu nous amuser à faire un algortihme de djikstra pour optimiser le voyage du camion poubelles.
\end{document}
